<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ad_dashboard.aspx.cs" Inherits="MotoPart.Admin_Page.ad_dashboard" %>
...
<head runat="server">
    ...
    <link href="ad_dashboard_style.css" rel="stylesheet" />
                    ...
                    <div class="custom_wrapper">
                        <div class="container_wrap">
                            <div class="profile_info">
                                <asp:ImageButton ID="user_profile" runat="server" OnClick="user_profile_Click"
            ...
            <div class="main-content">
                <div class="card">
                    <div class="custom-header">
                        <asp:Label ID="lbl_staff" runat="server" Text="Staff"></asp:Label>
                    </div>
                    <div class="card-content">

                        <asp:GridView ID="staff_grid" runat="server" AutoGenerateColumns="False" OnRowDataBound="staff_grid_RowDataBound" CellPadding="4" GridLines="None" ForeColor="#333333">
                            ...
                            <RowStyle BackColor="#C9D1D3" ForeColor="#333333" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="260px" HeaderText="STAFF NAME">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_staffName" runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField ItemStyle-Width="290px" HeaderText="EMAIL">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="ADDRESS">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_staffadd" runat="server" Text='<%# Eval("STAFF_ADDRESS") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField ItemStyle-Width="180px" HeaderText="CONTACT #">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField ItemStyle-Width="220px" HeaderText="DATE CREATED">
                                    <ItemTemplate>
                ...
                <div class="card">
                    <div class="custom-header">
                        <asp:Label ID="lbl_appReq" runat="server" Text="Approve Requests"></asp:Label>
                    </div>
                    <div class="card-content">
                        <asp:GridView ID="req_stat" runat="server" AutoGenerateColumns="False" AutoPostBack="True" Width="100%" CssClass="dsplygrid" OnRowCommand="req_stat_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Button runat="server" Text="View" CommandName="View" CommandArgument='<%# Container.DataItemIndex %>' CssClass="view_btn" />
                                    </ItemTemplate>
