<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="staff_delivery.aspx.cs" Inherits="MotoPart.MotoParts.staff_delivery" %>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="staff_dashboard.aspx">Home </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="staff_delivery.aspx">Delivery
                    ...
                    <div class="icons">
                        <ul class="navbar-nav me-auto">
                            ...
                            <li>
                                <button type="button" class="icon-button nav-link">
                                    <span class="material-icon"><i class="bi bi-bell-fill"></i></span>
                                    <span class="icon-button-badge"><i class="bi bi-circle-fill"></i></span>
                                </button>
                            </li>
                        </ul>
                    </div>
