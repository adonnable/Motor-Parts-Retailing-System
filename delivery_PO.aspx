<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="delivery_PO.aspx.cs" Inherits="MotoPart.MotoParts.delivery_PO" %>
...
<head runat="server">
   <title></title>
    ...
    <link href="delivery_PO.css" rel="stylesheet" />
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="header">
                ...
                <div class="POandDate">
                    <div>
                        <b>Delivery #:</b>
                        <asp:Label ID="deliver_num" runat="server" Text=""></asp:Label>
                    </div>
                    <div>
                        <b>PO #:</b>
            ...
            <div class="product-list">
                <asp:GridView ID="reqItems" runat="server" OnRowCommand="Item_RowCommand" CellPadding="10" CellSpacing="5" ForeColor="#333333" GridLines="None">
                    <Columns>
                              <asp:ButtonField Text="Edit" CommandName="EditBtn" />
                    </Columns>
            ...
            <div class="buttons">
                <asp:Button class="btn btn-danger" OnClientClick="return confirm('Are you sure? (Cancel Confirmation)');" ID="cancelBtn" runat="server" Text="Cancel" OnClick="cancelBtn_Click" />
                <asp:Button class="btn btn-success" OnClientClick="return confirm('Are you sure? (Completed Confirmation)');" ID="receivedBtn" runat="server" Text="Completed" OnClick="receivedBtn_Click" />
            </div>
        </div>
    </form>
</body>
