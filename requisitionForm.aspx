<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="requisitionForm.aspx.cs" Inherits="MotoPart.MotoParts.requisitionForm" %>
...
<head runat="server">
    ...
    <link href="requisitionForm_style.css" rel="stylesheet" />
</head>
<body>
            ...
            <div class="main-content">
                ...
                <div class="card">
                    ...
                    <div class="req-form">
                        ...
                        <div class="btns">
                            <asp:Button ID="req_again" runat="server" Text="Create Request" class="btn btn-primary" Onclick="req_again_Click"/>
                            <asp:Button ID="req_cancel" runat="server" Text="Cancel Request" class="btn btn-warning" OnClick="req_cancel_Click"/>
                        </div>
                    </div>
                </div>
            </div>
